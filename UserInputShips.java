...
class UserInputShips{
  ...
  public static void firstShipCoord(String a,String b,int c, String[][][] grid){
    ...
    final String colorReset = "\u001B[0m"; //white
    while(!done){
      done=true;
    ...
    //assigning integers based on direction to coordinates
    ...
    //assinging ships to grid based on direction you picked
    if(lastX==xCoord){
      if (yCoord<lastY){
  ...
  public static String shipDirection(String a,String b,int c, String[][][] grid,int x,int y){
    ...
    System.out.print("If you wanna change your point type in \"CANCEL\"\n\nPlease type either \"UP\" \"DOWN\" \"LEFT\" \"RIGHT\"\n ");
  ...
  //scanner for your coordinate input
